...
El sistema ofrece dos principales opciones en cuento a la exportación y visualización, las cuales son un \textbf{reporte HTML} completo y un archivo SVG para una mejor \textbf{visualización del AST}. Una decisión personal fue solo usar SVG para el AST y no para el reporte HTML por una razón simple: el uso del formato de vectores SVG implica muchas líneas de código referentes al cálculo de coordenadas, lo cual hace el código difícilmente legible. Por lo que para las estadísticas mostradas en el reporte HTML, las cuales son modelables con HTML\texttt{+}CSS puro, se decidió sacrificar un poco la calidad del gráfico a costa de mejorar la legibilidad del código. 
...
\subsubsection{Gráfico de barras HTML+CSS}
